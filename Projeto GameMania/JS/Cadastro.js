window.onload = function cadastro(){
    var cadastro = document.getElementById('Realizar Cadastro');
    var login = document.getElementById('Fazer Login');
    fazerCadastro(cadastro, login);
}
function fazerCadastro(username, lastname, email, password, posicao){
    localStorage.setItem("username"+posicao, username);
    localStorage.setItem("lastname"+posicao, lastname);
    localStorage.setItem("email"+posicao, email);
    localStorage.setItem("password"+posicao, password);
}
